...
PIN_CONFIG = {
    ...
    # # ========== CN7 (Tab.21) ==========
    # "D16": _in(Pin.cpu.C6),   # PC6  | CN7-1  | I2S_A_MCK
    # "D15": _in(Pin.cpu.B8),   # PB8  | CN7-2  | I2C_A_SCL
    ...
    # "D21": _in(Pin.cpu.C7),   # PC7  | CN7-11 | I2S_B_MCK
    # "D12": _in(Pin.cpu.G9),   # PG9  | CN7-12 | SPI_A_MISO
    ...
    # "D10": _in(Pin.cpu.D14),  # PD14 | CN7-16 | SPI_A_CS/TIM4_CH3
    # "D24": _in(Pin.cpu.G10),  # PG10 | CN7-17 | SPI_B_NSS
